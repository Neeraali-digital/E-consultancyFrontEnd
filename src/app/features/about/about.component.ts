...
export class AboutComponent implements OnInit {
  ...
  milestones = [
    { year: 2003, title: 'Foundation', description: 'Our Journey Started.', icon: 'flag' },
    { year: 2004, title: 'Partnerships', description: '20 top institutional partnerships in Karnataka', icon: 'handshake' },
    { year: 2005, title: 'First Success', description: 'Successfully admitted 500 happy candidates.', icon: 'school' },
    { year: 2006, title: 'ISO Certification', description: 'South India\'s first ISO-certified education consultancy.', icon: 'verified' },
    { year: 2007, title: 'Medical Leadership', description: 'Become the leading PG medical education consultants in Bangalore.', icon: 'medical_services' },
    { year: 2008, title: 'Recognition', description: 'Awarded Best Education Consultancy in Karnataka.', icon: 'emoji_events' },
    { year: 2009, title: 'National Expansion', description: 'Achieved the milestone of opening 10 offices across the country.', icon: 'location_city' },
    { year: 2010, title: 'Headquarters', description: 'Our headquarters opened at MG Road, the central hub of Bangalore.', icon: 'business' },
    { year: 2011, title: 'Direct MOUs', description: 'Signed direct MOUs with 50 institutions.', icon: 'edit_document' },
    { year: 2012, title: 'Northeast Expansion', description: 'We opened our first office in Northeast India, located in Agartala.', icon: 'explore' },
    { year: 2013, title: '10th Anniversary', description: 'In our 10th anniversary year, we fully sponsored the course fees of 10 needy students.', icon: 'cake' },
    { year: 2014, title: 'Major Milestone', description: 'Successfully achieved the milestone of 5,000 admissions.', icon: 'military_tech' },
    { year: 2015, title: 'Excellence Award', description: 'Education Excellence Award Winner', icon: 'workspace_premium' },
    { year: 2016, title: 'Education Fair', description: 'Our collaboration with the biggest education fair in Northeast India has begun.', icon: 'festival' },
    { year: 2017, title: 'Regional Leadership', description: 'Become South India\'s leading education consultancy.', icon: 'public' },
    { year: 2018, title: 'Team Growth', description: 'A team of 200+ in-house staff and more than 1,000 associates.', icon: 'groups' },
    { year: 2019, title: 'Global Presence', description: 'Successfully set up 20 offices across India and abroad.', icon: 'public' },
    { year: 2020, title: 'National Leadership', description: 'Became India\'s leading education consultancy for domestic admissions.', icon: 'leaderboard' },
    { year: 2021, title: 'Corporate Structure', description: 'Incorporated as a Private Limited Company.', icon: 'corporate_fare' },
    { year: 2022, title: 'Industry Leadership', description: 'Our MD became the Founder and National President of the Education Consultants Association of India (ECAI).', icon: 'person' },
    { year: 2023, title: 'Excellence Milestone', description: 'Achieved the milestone of 10,000 successful admissions.', icon: 'military_tech' },
    { year: 2024, title: 'International Programs', description: 'Launched MBBS abroad program.', icon: 'flight_takeoff' }
  ];
